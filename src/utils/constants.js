...
export const walkerEnglish = `TravelGOat offers walker services tailored specifically for
...
export const walkerGerman = `TravelGOat bietet speziell auf Wanderer zugeschnittene Dienstleistungen an
...
export const walkerHindi =`TravelGOat विशेष रूप से शारीरिक अक्षमताओं वाले व्यक्तियों के लिए तैयार की गई वॉकर सेवाएं प्रदान 
...
export const carEnglish = `TravelGOat, our website, provides transportation services that are
...
export const carGerman = `TravelGOat, unsere Website, bietet Transportdienste, die für Menschen 
...
export const carHindi= `TravelGOat, हमारी वेबसाइट, परिवहन सेवाएं प्रदान करती है जो शारीरिक अक्षमताओं 
...
export const busEnglish =  ` TravelGOat, our website, is committed to providing accessible
...
export const busGerman = `TravelGOat, unsere Website, ist bestrebt, barrierefrei zu sein
...
export const busHindi = `TravelGOat, हमारी वेबसाइट, सुलभ प्रदान करने के लिए प्रतिबद्ध है
...
export const trainEnglish = ` At TravelGOat, our website offers inclusive and accessible
transportation services for individuals with physical disabilities,
...
export const trainGerman = `Bei TravelGOat bietet unsere Website inklusive und barrierefrei
...
export const trainHindi = `TravelGOat में, हमारी वेबसाइट समावेशी और सुलभ प्रदान करती है
शारीरिक विकलांग व्यक्तियों के लिए परिवहन सेवाएं,
...
export const flightEnglish = `TravelGOat, our website, is dedicated to offering accessible
transportation services for individuals with physical disabilities,
...
export const flightGerman = `TravelGOat, unsere Website, widmet sich dem Angebot barrierefreier Angebote
Fahrdienste für Menschen mit körperlichen Behinderungen,
...
export const flightHindi = `TravelGOat, हमारी वेबसाइट, सुलभ पेशकश करने के लिए समर्पित है
शारीरिक विकलांग व्यक्तियों के लिए परिवहन सेवाएं,
...
export const washroomGerman = `TravelGOat, unsere Website, erkennt die Bedeutung von Zugänglichkeit an
...
export const washroomHindi=`TravelGOat, हमारी वेबसाइट, सुलभ के महत्व को पहचानती है
...
export const careTakerEnglish = ` TravelGOat, our website, offers care taker services that are
...
export const careTakerGerman = `TravelGOat, unsere Website, bietet Betreuungsdienste an, die es sind
...
export const careTakerHindi = `TravelGOat, हमारी वेबसाइट, केयर टेकर सेवाएं प्रदान करती है
